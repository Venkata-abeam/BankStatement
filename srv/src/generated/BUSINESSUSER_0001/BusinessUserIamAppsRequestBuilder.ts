 ...
 */
export class BusinessUserIamAppsRequestBuilder<
...
> extends RequestBuilder<BusinessUserIamApps<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<BusinessUserIamApps<T>, T> {
    return new GetAllRequestBuilder<BusinessUserIamApps<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessUserIamApps<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessUserIamApps<T>, T>(
      this.entityApi,
      {
        UserID: userId,
        AppID: appId
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessUserIamApps<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<BusinessUserIamApps<T>, T>(
      this.entityApi,
      userIdOrEntity instanceof BusinessUserIamApps
        ? userIdOrEntity
        : {
