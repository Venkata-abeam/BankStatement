 ...
 */
export class BusinessUserAutoLockStatusRequestBuilder<
...
> extends RequestBuilder<BusinessUserAutoLockStatus<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<BusinessUserAutoLockStatus<T>, T> {
    return new GetAllRequestBuilder<BusinessUserAutoLockStatus<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessUserAutoLockStatus<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessUserAutoLockStatus<T>, T>(
      this.entityApi,
      { BusinessUserAutoLockStatus: businessUserAutoLockStatus }
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessUserAutoLockStatus<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    businessUserAutoLockStatusOrEntity: any
  ): DeleteRequestBuilder<BusinessUserAutoLockStatus<T>, T> {
    return new DeleteRequestBuilder<BusinessUserAutoLockStatus<T>, T>(
      this.entityApi,
      businessUserAutoLockStatusOrEntity instanceof BusinessUserAutoLockStatus
