 ...
 */
export class BusinessUserApplicationJobsRequestBuilder<
...
> extends RequestBuilder<BusinessUserApplicationJobs<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<BusinessUserApplicationJobs<T>, T> {
    return new GetAllRequestBuilder<BusinessUserApplicationJobs<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessUserApplicationJobs<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessUserApplicationJobs<T>, T>(
      this.entityApi,
      {
        UserID: userId,
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessUserApplicationJobs<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<BusinessUserApplicationJobs<T>, T>(
      this.entityApi,
      userIdOrEntity instanceof BusinessUserApplicationJobs
        ? userIdOrEntity
        : {
