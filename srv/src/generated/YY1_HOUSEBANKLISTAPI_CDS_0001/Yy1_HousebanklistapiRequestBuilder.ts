 ...
 */
export class Yy1_HousebanklistapiRequestBuilder<
...
> extends RequestBuilder<Yy1_Housebanklistapi<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Housebanklistapi<T>, T> {
    return new GetAllRequestBuilder<Yy1_Housebanklistapi<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Housebanklistapi<T>, T>(
      this.entityApi,
      {
