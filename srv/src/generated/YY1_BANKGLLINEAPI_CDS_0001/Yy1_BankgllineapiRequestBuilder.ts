 ...
 */
export class Yy1_BankgllineapiRequestBuilder<
...
> extends RequestBuilder<Yy1_Bankgllineapi<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Bankgllineapi<T>, T> {
    return new GetAllRequestBuilder<Yy1_Bankgllineapi<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Bankgllineapi<T>, T>(this.entityApi, {
      ID: id
    });
  }
}
