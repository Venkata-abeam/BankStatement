...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultYy1BankgllineapiCds0001Path,
...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteYy1BankgllineapiCds0001RequestBuilder<DeSerializersT>
    | Array<WriteYy1BankgllineapiCds0001RequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteYy1BankgllineapiCds0001RequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultYy1BankgllineapiCds0001Path =
